namespace RecordingBot.Services.Bot{
    ...
    public interface IConfiguration : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets BlobStorageConnectionString.
        /// </summary>
        string BlobStorageConnectionString { get; set; }

        /// <summary>
        /// Gets or sets BlobStorageContainerName.
        /// </summary>
        string BlobStorageContainerName { get; set; }

        /// <summary>
        /// Gets or sets NameGetUrl.
        /// </summary>
        string NameGetUrl { get; set; }

        /// <summary>
        /// Gets or sets NameGetApiKey.
        /// </summary>
        string NameGetApiKey { get; set; }


        /// <summary>
        /// Gets or sets VirtualLobbyApiDomain.
        /// </summary>
        string VirtualLobbyApiDomain { get; set; }

        /// <summary>
        /// Gets or sets VirtualLobbyApiKey.
        /// </summary>
        string VirtualLobbyApiKey { get; set; }
